...
const AI_101: Story[] = [
  ...
  { id: 'what-is-a-prompt', cat: 'AI 101', catLabel: 'AI 101', img: 'https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?w=600&q=80', alt: 'Woman writing in a notebook at a desk with warm lamp light', title: 'What Is a Prompt, Really? The One Skill That Changes Everything.', desc: 'How you talk to AI is everything. This is the single skill that determines whether it saves you an hour — or wastes one.' },
  { id: '25-prompts-spring', cat: 'AI 101', catLabel: 'AI 101', img: 'https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?w=600&q=80', alt: 'Woman smiling at her phone with a notepad nearby', title: '25 AI Prompts Every Mother Needs This Spring', desc: 'Copy, paste, customize. From camp applications to end-of-year teacher gifts — your spring prompt starter kit.', badges: [{ type: 'video', text: 'Watch: Live Demo' }, { type: 'seasonal', text: '🌸 Spring' }] },
  { id: 'ai-habits', cat: 'AI 101', catLabel: 'AI 101', img: 'https://images.unsplash.com/photo-1571844307880-751c6d86f3f3?w=600&q=80', alt: 'Woman at window with laptop, morning light coming through', title: 'The AI Habits That Will Define the Next Five Years', desc: "The mothers who use AI well aren't the most tech-savvy — they have the right habits. Here's what to build, starting this week." },
];
...
const HOME: Story[] = [
  ...
  { id: 'meal-planning', cat: 'HOME', catLabel: 'HOME', img: 'https://images.unsplash.com/photo-1547592180-85f173990554?w=600&q=80', alt: 'Woman with tablet in a bright kitchen, fresh ingredients on counter', title: 'Every Way to Use AI for Meal Planning — Ranked', desc: "One-off prompts, our Meal Planner micro-tool, AI family apps, the weekly reset with Aime. We tested them all so you don't have to.", badges: [{ type: 'tool', text: '✦ Try the Meal Planner Tool' }, { type: 'video', text: 'Watch: Kitchen Demo' }] },
  { id: 'family-command-center', cat: 'HOME', catLabel: 'HOME', img: 'https://images.unsplash.com/photo-1506784983877-45594efa4cbe?w=600&q=80', alt: 'Organized family calendar on wall, woman reviewing it with coffee', title: 'How to Build a Family Command Center Powered by AI', desc: 'Schedules, meals, logistics, handoffs — one AI-powered system to run it all. We teach this step-by-step in the course.', badges: [{ type: 'video', text: 'Watch: Quick Tour' }] },
  ...
  { id: 'birthday-party', cat: 'HOME', catLabel: 'HOME', img: 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=600&q=80', alt: "Beautifully decorated children's birthday party setup with balloons", title: "I Planned a Birthday Party in 4 Minutes With AI. Here's the Prompt.", desc: 'Theme, vendors, invites, timeline, dietary restrictions, thank-you notes. The prompt is right here — take it.' },
  { id: 'sunday-reset', cat: 'HOME', catLabel: 'HOME', img: 'https://images.unsplash.com/photo-1491975474562-1f4e30bc9468?w=600&q=80', alt: 'Woman with coffee and planner on a Sunday morning, looking calm', title: 'Your Sunday Reset, Powered by Aime', desc: 'Run your weekly reset through Aime — meals, schedule, tasks, mental prep. Fifteen minutes on Sunday that changes everything about Monday.', badges: [{ type: 'tool', text: '✦ Meet Aime' }, { type: 'video', text: 'Watch: Reset Demo' }] },
  ...
  { id: 'delegate-to-ai', cat: 'HOME', catLabel: 'HOME', img: 'https://images.unsplash.com/photo-1554774853-aae0a22c8aa4?w=600&q=80', alt: 'Confident woman at desk, pointing at laptop screen with purpose', title: "How to Delegate to AI Like You'd Delegate to an EA", desc: 'Stop asking questions. Start giving instructions. The mindset shift that turns AI from a novelty into a necessity.' },
  { id: '3-ai-setups', cat: 'HOME', catLabel: 'HOME', img: 'https://images.unsplash.com/photo-1563986768494-4dee2763ff3f?w=600&q=80', alt: 'Woman setting up a calm organized home workspace with plants', title: 'The 3 AI Setups Every Mom Should Have Running by Monday', desc: 'Three systems. Twenty minutes. A completely different week.' },
];
...
const SEASONAL: Story[] = [
  ...
  { id: 'summer-family-trip', cat: 'SEASONAL', catLabel: 'SEASONAL', img: 'https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=600&q=80', alt: 'Mom and daughter at an airport with luggage, looking excited', title: 'How to Plan a Family Summer Trip in One Afternoon With AI', desc: 'Destination research, itinerary, packing lists, kid-friendly restaurants, backup plans. One session with AI, one summer your family will actually remember.', badges: [{ type: 'seasonal', text: '☀️ Summer Travel' }] },
  ...
  { id: 'back-to-school', cat: 'SEASONAL', catLabel: 'SEASONAL', img: 'https://images.unsplash.com/photo-1588072432836-e10032774350?w=600&q=80', alt: 'Mom and child looking at school backpack and supplies together', title: 'How to Automate the School Year — Before It Starts', desc: 'Forms, deadlines, supply lists, permission slips. Set it up with AI in one Sunday afternoon and run the whole year on autopilot.', badges: [{ type: 'seasonal', text: '🍂 Back to School' }] },
...
const MILESTONES: Story[] = [
  { id: 'new-mom', cat: 'MILESTONES', catLabel: 'MILESTONES', img: 'https://images.unsplash.com/photo-1555252333-9f8e92e65df9?w=600&q=80', alt: 'New mom holding a newborn baby, looking tender and slightly overwhelmed', title: "The New Mom's AI Starter Kit (For the 4th Trimester)", desc: "You just had a baby. Your brain is running on empty. Here's the AI setup that handles feeding schedules, thank-you notes, pediatrician questions, and all the decisions you shouldn't have to be making right now." },
  { id: 'toddler-years', cat: 'MILESTONES', catLabel: 'MILESTONES', img: 'https://images.unsplash.com/photo-1476703993599-0035a21b17a9?w=600&q=80', alt: 'Mom sitting on floor playing with a toddler, both laughing', title: 'The Toddler Years Are Chaos. AI Is Your Secret Weapon.', desc: "Sleep regression research at 2am. Activity ideas when you've run out. Pediatrician prep. The questions you're embarrassed to Google. AI handles all of it, without judgment." },
  { id: 'elementary-school', cat: 'MILESTONES', catLabel: 'MILESTONES', img: 'https://images.unsplash.com/photo-1503919545889-aef636e10ad4?w=600&q=80', alt: 'Mom walking an elementary-age child to school, holding hands on a sunny morning', title: "Elementary School Mom: You're Now the Family Logistics Director", desc: 'Playdates, carpools, homework, reading logs, class parties, teacher emails. The volume just went up — here’s how AI absorbs the operational load.' },
  { id: 'middle-school', cat: 'MILESTONES', catLabel: 'MILESTONES', img: 'https://images.unsplash.com/photo-1531983412531-1f49a365ffed?w=600&q=80', alt: 'Mom and teen daughter talking at the kitchen table, warm and honest moment', title: 'Middle School: When the Emotional Load Gets as Heavy as the Logistics', desc: 'Friend drama, academic pressure, phone boundaries, the sudden need to be everywhere and nowhere at once. How AI helps you manage it all — and actually be present.' },
  ...
  { id: 'empty-nest', cat: 'MILESTONES', catLabel: 'MILESTONES', img: 'https://images.unsplash.com/photo-1525921429624-479b6a26d84d?w=600&q=80', alt: 'Mom hugging college-age child at a campus with an emotional smile', title: 'College Drop-Off Is a Grief Nobody Prepares You For', desc: "She's gone. Now what? How mothers in the empty nest chapter are using AI not just to organize — but to rediscover who they are when the job description changes." },
  { id: 'perimenopause', cat: 'MILESTONES', catLabel: 'MILESTONES', img: 'https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=600&q=80', alt: 'Woman working at desk at home with natural light, focused and calm', title: 'Perimenopause + the Mental Load: The Double Burden Nobody Is Talking About', desc: 'Brain fog, hormonal shifts, still running the household, possibly at peak career demands. How AI becomes essential — not optional — at this life stage.' },
  ...
  { id: 'solo-mom', cat: 'MILESTONES', catLabel: 'MILESTONES', img: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=600&q=80', alt: 'Single mom on couch with laptop open and child nearby, managing it all', title: "Solo Mom, AI Co-Pilot: You Shouldn't Have to Do This Alone", desc: "Single mothers carry 100% of the invisible load. AI doesn't replace support — but it does handle a significant portion of the cognitive labor that's been entirely on you." },
...
const WORK: Story[] = [
  ...
  { id: 'working-mom-playbook', cat: 'WORK', catLabel: 'WORK', img: 'https://images.unsplash.com/photo-1573496799652-408c2ac9fe98?w=600&q=80', alt: 'Woman walking into a modern office building, confident stride, bag over shoulder', title: "The Working Mom's AI Playbook", desc: 'Six workflows that let you perform at your peak — even on the days when everything else is also happening at once.', badges: [{ type: 'video', text: 'Watch: Playbook Walkthrough' }] },
];

const TOOLS: Story[] = [
  { id: 'meet-aime', cat: 'TOOLS', catLabel: 'TOOLS & AIME', img: 'https://images.unsplash.com/photo-1649972904349-6e44c42644a7?w=600&q=80', alt: 'Woman relaxed on sofa with laptop open, looking peaceful and unbothered', title: 'Meet Aime: Your AI Chief Everything Officer™', desc: 'She runs your household. Manages your week. Never sleeps, never judges, and never needs to be thanked. Meet the assistant you actually deserve.', badges: [{ type: 'tool', text: '✦ Try Aime Free' }, { type: 'video', text: 'Watch: Aime in Action' }] },
  { id: 'micro-tools', cat: 'TOOLS', catLabel: 'TOOLS & AIME', img: 'https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?w=600&q=80', alt: 'Woman scrolling through apps on her phone at a kitchen table', title: "The ai.moms™ Micro-Tools You Didn't Know You Needed", desc: 'Meal planning, camp finding, babysitter vetting — purpose-built tools that do one thing exceptionally well.', badges: [{ type: 'tool', text: '✦ Browse All Tools' }] },
...
const NEUROSCIENCE: Story[] = [
  ...
  { id: 'decision-fatigue', cat: 'NEUROSCIENCE', catLabel: 'NEUROSCIENCE', img: 'https://images.unsplash.com/photo-1490623970972-ae8bb3da443e?w=600&q=80', alt: 'Tired woman at a desk, head in hands, stacks of papers around her', title: "Decision Fatigue Is Real. Here's the Research — And the Fix.", desc: 'What happens to your brain after decision 200 — and how mothers can use AI to protect the cognitive bandwidth that matters most.' },
  { id: 'delegation-science', cat: 'NEUROSCIENCE', catLabel: 'NEUROSCIENCE', img: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=600&q=80', alt: 'Woman presenting confidently at a whiteboard to a small attentive group', title: 'The Science Behind Why Delegation Feels So Hard — And How AI Rewires It', desc: 'Perfectionism, over-responsibility, the hypervigilance loop. The neuroscience of why letting go is hard — and how AI gives you a guilt-free exit.' },
];
